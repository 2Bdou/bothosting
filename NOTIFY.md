...
send_notification("续期成功\n到期：2026-08-01", title="Bot-hosting 续期通知")

# 返回 bool：已配置通道且全部失败时为 False（并打印 ::warning::）
ok = send_notification("正文", title="Bot-hosting 续期通知")

# 或本仓库 app.py 里的封装
# notify(format_notification("✅ 续期成功", expiry_date="..."))
```
